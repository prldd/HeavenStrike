...
const UNITS := [
	...
	{"name": "Ironroot", "kind": "Warden", "cost": 2, "atk": 1, "hp": 7, "move": 2, "range": 1, "text": "Taunts enemies within 2 spaces, locking their row."},
	{"name": "Stoneveil", "kind": "Warden", "cost": 4, "atk": 2, "hp": 9, "move": 2, "range": 1, "text": "Taunts enemies within 2 spaces, locking their row."},
	{"name": "Cloudwall", "kind": "Warden", "cost": 5, "atk": 2, "hp": 12, "move": 2, "range": 1, "text": "Taunts enemies within 2 spaces, locking their row."},
