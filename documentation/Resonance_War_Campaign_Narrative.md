...
> existing 62-mission campaign onto the foundation's story beats, groups
> missions into individually compelling bundles (seasons and chapters), and
> outlines the new missions needed for Act III. It is a writing and
> implementation plan, not final script.
...
The seasons map onto the code as follows: Season One = current `act: 1`,
Season Two = current `act: 2`, Season Three = a new `act: 3`. No existing
mission moves or renumbers.

# Recurring Cast

The foundation names only the player and Cassian. The campaign needs a small
supporting cast. These are proposals; two are anchored to existing mission
titles so they cost no new titles.
...
- **Adele Voss** (anchored to M5 "Adele", M30 "Recon, Adele-style") — a
...
- **The Stranger** (anchored to M7 "The Stranger", M42 "Stranger's Tide") —
  a quiet figure who knows far too much about Caelian installations. Revealed
  at the end of Season Two as a warden of Caelis.
- **The Archivist** (anchored to M41 "The Bookworm") — an Order scholar met at
...
- **M1 Training Day** — A joint reclamation expedition works a dormant
...
- **M3 Cause for Alarm** — The relay synchronizes unexpectedly during a
  ...
  conducting.
- **M4 Into the Fire** — Escape through the burning site. The player drags
...
- **M5 Adele** — Adele Voss arrives to assess salvage rights and write the
  incident report. Looters hit the site; the player conducts openly for the
  first time, and Adele writes down what she saw.
- **M6 Calendar Girl** — The expedition's patrons stage a publicity event to
...
- **M7 The Stranger** — A stranger tells the player the relay activation was
  no accident, then disappears before the questions start. The season's
  engine starts here.
- **M8 Scrap Merchants** — Scavenger crews contest the expedition's salvage
  claim. Lawfully murky: everyone has paperwork, nobody has permission.
- **M9 Raider Way** — Raiders hit the convoy moving the reclaimed tech.
  Cassian negotiates passage rights afterward — his first visible win.

## Chapter 3 — Claims (M10–14)

- **M10 Class Dismissed** — Governments require Conductor registration. The
  "certification exam" is a faction evaluation in disguise; everyone scores
  the player except the player.
- **M11 Base Defence** — The expedition depot is attacked during the
...
- **M12 Ambush** — A second ambush, too professional to be raiders. The
  player finds contractor gear; Cassian begins controlling who knows that.
- **M13 Determination** — Three faction envoys, three offers, one refusal.
  The answer comes back as a "safety inspection" with teeth. The older
  automatons begin showing distinct habits.
- **M14 Stunt Woman** — Adele returns with a dangerous plan to prove the
...
- **M15 The Bridge** — A Caelian transit bridge fails under load. The player
...
- **M16 The Overconfident** — A faction champion challenges the "salvage
...
- **M17 Aftermath** — Hearings over the bridge and the duel. Competing
  narratives fight in the streets; the player's testimony is edited before
  it is heard.
- **M18 Proving Grounds** — A formal evaluation of Conductor limits, run by
  a scrupulously fair officer. The cost of conducting (strain, collapse,
  medical tents) is shown for the first time.
- **M19 Wild Things** — Conductor-less automatons running on resonance scars
...
- **M20 Encampment** — The displaced township camps by the depot. Defending
...
- **M21 Sanctuary: Outside** — Following the Stranger's coordinates, the
...
- **M22 Sanctuary: Inside** — Inside the archive: maintenance logs dated
...
- **M23 On A Mission** — Operating under Cassian's new reclamation charter,
  the player escorts Order scholars through contested territory. The
  charter's first test.
- **M24 Showing Off** — Every faction tries to recruit or showcase the
...
- **M25 Arena: Heat 1** — The Grand Circuit: where factions settle disputes
  by proxy champion. The charter needs a seat at the table; the price of
  admission is winning. The reigning champion's name is Minerva.
- **M26 Arena: Heat 2** — Crowd favorite vs. crowd's villain; the player
  learns the arena is a legislature with better catering.
- **M27 Arena: Quarter Finals** — Cassian works the boxes while the player
  works the bracket. Two victories per round now.
- **M28 Arena: Semi-Finals** — An opponent throws the match on orders; the
  player realizes the fix was meant as a gift, and refuses it by winning
  anyway.
- **M29 Hit It, Slash It, Stab It!** — The final. The player takes the
...
- **M36 Mission Accomplished** — Leaders declare the crisis resolved for the
...
- **M37 A Heroes' Welcome** — Return to the township from M19. An old
  caretaker recognizes one of the player's automatons from before the
  collapse — a resonance scar with a name attached.
- **M38 Left Behind** — A commune refuses evacuation from degrading
...
- **M52 Three's A Crowd** — A three-way negotiation collapses into a brawl
...
- **M55 No Holding Back** — Full-scale faction offensive. The player runs
  ...
  for the field.
- **M56 One By One** — Coalition delegates are assassinated one by one. The
  player protects the survivors — and finally sees the full extent of
  Cassian's information network when it saves them.
- **M57 Rhetorical Question** — A public tribunal asks the only question
...
- **M62 The Showdown** — Season finale. Every faction army reaches the gate
...
- **M63 The Gate Opens** — Entry terms are set by the city's wardens:
  ...
  malfunction.
- **M64 Still Running** — The Outer City is immaculate and empty: a
  civilization maintained by machines for citizens who never came back.
  What resonance scars look like given centuries.
- **M65 The Wardens' Test** — The wardens will not let an unregistered,
...
- **M66 The True History** — The full record: the Source crisis, the vote to
...
- **M67 Five Fragments** — Each faction's founding myth is here, annotated:
...
- **M68 What Was Sealed** — The most destabilizing evidence the foundation
...
- **M69 The First Conductors** — What the Empire's Conductors were, what
...
- **M70 The Experiment** — The player's origin recontextualized: the relay
...
- **M71 Succession** — The wardens offer the player the Vault's purpose:
  become the next warden of the system. A genuine offer, honestly meant,
  and the wrong answer.

## Chapter 14 — The Civic Core (M72–74)

- **M72 The Petition** — Caelis petitions to resume stewardship of the
...
- **M73 Old Habits** — Hardliners on *both* sides (Caelian restorationists
  and faction maximalists) try to collapse the talks. The player protects
  a negotiation they are not invited to lead.
- **M74 The Architect** — Cassian drafts the Accord. The player's role in
...
- **M75 The Balancing Network** — The final reveal: the Source is not a
  ...
  civilization.
- **M76 The Resonance War** — The last battle: not for control of the
...
- **M77 Accord** — Finale and epilogue. Partial truth made public, the
...
- Keep existing mission titles — they are load-bearing in code and several
  (Adele, The Stranger, The Bookworm, Stranger's Tide) are now cast anchors.
